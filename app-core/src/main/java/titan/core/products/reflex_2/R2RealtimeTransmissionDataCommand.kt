...
const val R2_REALTIME_TRANSMISSION_DATA = "r2_realtime_transmission_data"

internal object R2RealtimeTransmissionDataCommand {
// todo
    fun setData() {
    ...
    fun getMessage(): Message {
        val message = Message()
        message.what = 1
        message.obj = ResponsePackage(R2_REALTIME_TRANSMISSION_DATA, HashMap(parseData))
        parseData.clear()
        return message
    }
...
internal data class R2RealtimeTransmissionData(var byteArray: ByteArray) {
